...
\begin{table}[ht]
	...
	\resizebox{\textwidth}{!}{
		...
		1 & 
		\begin{enumerate}
			\item Pemilihan Ketua, 
		\end{enumerate} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} &  &  &  &  &  &  &  &  &  &  & XXX \\
		\hline
		2 & kata kata hari ini &  &  &  & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} & \cellcolor{yellow} &  &  &  &  &  &  &  & XXX \\
		\hline
		\end{tabular}
	}
